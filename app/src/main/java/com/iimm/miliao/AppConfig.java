...
public class AppConfig {
    ...
    public String OPENSCREENAD;//
    public String ADVERTISINGDISTRIBUTED;///api/advertisingDistributed
    public String ADVERTISINGINCOME;//
    ...
    public String GET_MUSIC_LIST;// 获取音乐列表 http://47.91.232.3:8601/music/list?access_token=20bc3cbda93241a8903a999a5ad71625&pageIndex=0&pageSize=20&keyword=94
    /* 直播 */
    ...
    private static void initApiUrls(AppConfig config) {
        ...
        config.OPENSCREENAD = apiUrl + "user/openScreenAd";
        config.ADVERTISINGDISTRIBUTED = apiUrl + "user/advertisingDistributed";
        config.ADVERTISINGINCOME = apiUrl + "user/advertisingIncome";
