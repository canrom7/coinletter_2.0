...
public class TTAdManagerHolder {
    ...
    public static void init(final Context context,String id) {
        //初始化穿山甲SDK
        doInit(context,id);
    }

    //step1:接入网盟广告sdk的初始化操作，详情见接入文档和穿山甲平台说明
    private static void doInit(Context context,String id) {
        if (sInit) {
//            Toast.makeText(context, "您已经初始化过了", Toast.LENGTH_LONG).show();
        ...
        TTAdSdk.init(context, buildConfig(context,id));
        sInit = true;
//        Toast.makeText(context, "初始化成功", Toast.LENGTH_LONG).show();
    ...
    private static TTAdConfig buildConfig(Context context,String id) {
