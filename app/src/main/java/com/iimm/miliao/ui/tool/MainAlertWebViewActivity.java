...
public class MainAlertWebViewActivity extends BaseActivity implements OnPermissionClickListener {
    ...
    private void initEvent() {
        mTitleRightIv.setOnClickListener(view -> {
            WebMoreDialog mWebMoreDialog = new WebMoreDialog(MainAlertWebViewActivity.this, getCurrentUrl(), new WebMoreDialog.BrowserActionClickListener() {
                ...
                @Override
                public void edit() {
                   MainAlertWebViewActivity.this.onClickReqPermission();
                }
            });
            mWebMoreDialog.show();
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case REQ_CODE_PER: {
                if (resultCode == RESULT_OK && data != null) {
                    Shooter shooter = new Shooter(MainAlertWebViewActivity.this, resultCode, data);
...
//                                    toast("Screenshot saved at " + path);
    ...
    private void toast(String str) {
        Toast.makeText(MainAlertWebViewActivity.this, str, Toast.LENGTH_LONG).show();
    }
    @Override
